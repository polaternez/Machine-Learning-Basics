...
#%% 2b__Create Model(polynomial regression2)
...
print(scaler2.inverse_transform(sv_regr.predict(scaler.transform([[11]]))))
print(scaler2.inverse_transform(sv_regr.predict(scaler.transform([[6.6]]))))
print(sv_regr.predict([[6.6]]))
